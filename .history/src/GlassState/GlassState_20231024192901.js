...
export default class GlassState extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedGlass: "./glassessImage/v1.jpg", // Thông tin kính được chọn
      modelImage: "./glassesImage/model.jpg", // Hình ảnh người mẫu mặc định
      glassTitle: "GUCCI G8850U", // Tiêu đề kính
      glassContent: "Light pink square lenses define these sunglasses, ending with amother of pearl effect tip. ", // Nội dung kính
    };
  }
