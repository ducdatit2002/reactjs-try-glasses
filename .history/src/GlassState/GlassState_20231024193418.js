...
export default class GlassState extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedGlass: glassArr[0], // Thông tin kính được chọn
      modelImage: "./glassesImage/model.jpg", // Hình ảnh người mẫu mặc định
      glassTitle: glassArr[0].name, // Tiêu đề kính
      glassContent: glassArr[0].desc, // Nội dung kính
    };
  }
...
<div style={{backgroundColor: 'rgba(0, 0, 0, 0.34)', padding: '1rem'}}><h1 className="display-5 text-white text-center">TRY GLASSES APP ONLINE</h1></div>
