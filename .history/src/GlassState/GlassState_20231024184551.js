    ...
    return (
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-6">
            <div className="model">
              <img src={this.state.selectedGlass ? this.state.selectedGlass.url : './img/model.jpg'} alt="Người mẫu" />
            </div>
          </div>
          ...
          <div className="col-6">
            <div className="glass-list">
              {glassArr.map((glass) => (
                ...
                >
                  <img src={'./img/' + glass.url} alt={glass.name} />
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="selected-glass">
          ...
          {this.state.selectedGlass && (
            <div>
              <img src={`./img/${this.state.selectedGlass}.jpg`} alt={this.state.selectedGlass.name} />
