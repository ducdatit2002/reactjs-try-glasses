            ...
            <div className="container">
              <div className="row mt-5">
                <div className="col-6 text-center">
                  <div className="img">
                    <img className="w-50" src={this.state.modelImage} alt="model" />
                    <div className="tryGlasses">
                      <img src={this.state.selectedGlass ? './glassesImage/' + this.state.selectedGlass.url : ''} alt="Kính được chọn" style={{ width: 154, opacity: "0.7" }} />
                    </div>
              ...
              <div className="row">
                <div className="col-12 p-5 mt-5 bg-white text-center glasses">
                  {glassArr.map((glass) => (
                    <span key={glass.id} onClick={() => this.selectGlass(glass)}>
                      <img src={'./glassesImage/' + glass.url} style={{ width: 110 }} />
                    </span>
                  ))}
                </div>
              </div>
